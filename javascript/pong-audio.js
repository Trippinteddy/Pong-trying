...
export var wallSound = new soundFile("https://github.com/anars/blank-audio/blob/master/30-minutes-of-silence.mp3"); //load sound
...
export var adventureMusic = new soundFile("https://github.com/anars/blank-audio/blob/master/30-minutes-of-silence.mp3");
soundArray.push(adventureMusic);
adventureMusic.player.loop = true;
adventureMusic.player.volume.value = -16;

export var villageMusic = new soundFile("https://github.com/anars/blank-audio/blob/master/30-minutes-of-silence.mp3");
